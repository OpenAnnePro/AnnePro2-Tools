        ...
        stage("Build Release") {
            parallel {
                ...
                stage('Build Release Windows i386') {
                    ...
                    post {
                        always {
                            archiveArtifacts artifacts: 'target/i686-pc-windows-msvc/release/annepro2_tools_i386.exe', caseSensitive: false, fingerprint: true, followSymlinks: false, onlyIfSuccessful: true
                        }
                    }
                }
            }
